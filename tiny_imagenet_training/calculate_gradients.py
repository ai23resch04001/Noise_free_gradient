...
parser.add_argument("--radius",type=float,required=True,help="radius for selection of neighbors")
parser.add_argument("--corruption_percentage",type=int,default=5)
#parser.add_argument("--target_model",default="inception")
...
print("======================== Settings ========================")
print("Model:",args["model"]," ,dataset: ",args["dataset"]," ,batch size: ",args["batch_size"],", radius: ",args["radius"])
...
if True:
    ...
    for epoch in range(args["epochs"]):
        ...
        for data_class in mapping_dict.keys():
                    ...
                    if len(gradient_list) == 0:
                        if args["model"]=="resnet50" or args["model"]=="inception":
                            ...
                            if args["dataset"]=='cifar10':
                                ...
                                gradient_list = ft_per_sample_grads[-2].reshape(-1, 102400)
                        ...
                        if args["model"]=="resnet50" or args["model"]=="inception":
                            ...
                            if args["dataset"]=='cifar10':
                                ...
                                gradient_list = torch.vstack((gradient_list ,ft_per_sample_grads[-2].reshape(-1, 102400)))
            ...
            # gradient_dict[data_class]=gradient_list.cpu().numpy()
